...
//  YYModel+Private.h
//  YakKit
//  From: EXTKeyPathCoding.h, libextobjc
//
...
#ifndef YYModel_Private_h
#define YYModel_Private_h

#define YYPrivate_WantsSafeKeyPaths DEBUG
//#define YYModel_Private_h_WantsSafeKeyPaths 0

#define SetCoder(CoderType) \
    __unused CoderType *__coder__ = nil;

#if YYPrivate_WantsSafeKeyPaths
    #define codingKey(path) \
        keypath(__coder__, path)
#else
    #define codingKey(path) #path
#endif
